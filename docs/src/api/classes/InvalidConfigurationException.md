...
[lib/src/exceptions/invalid-configuration.exception.ts:6](https://github.com/joonashak/nestjs-clone-bay/blob/79758ff/lib/src/exceptions/invalid-configuration.exception.ts#L6)
