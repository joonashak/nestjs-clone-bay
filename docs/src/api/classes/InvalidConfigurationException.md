...
[lib/src/exceptions/invalid-configuration.exception.ts:6](https://github.com/joonashak/nestjs-clone-bay/blob/a434a6f/lib/src/exceptions/invalid-configuration.exception.ts#L6)
